...
Tags:address,address book,business directory plugin,business-directory,city portal,city portal plugin, classified ads,classifieds,directory plugin,directory widget,member directory,members directory,wordpress business directory,wordpress directory,wordpress directory plugin,wordpress directory theme,listwp,Business Directory,catalog,business,businesses,company,company listing,custom directory,directory index,white pages,list,lists,listings,profile,geodirectory
...
Helps you build directories and category based business listings. Search or browse local businesses within the directory.

== Description ==

If you’re looking to become a local business authority, the WordPress Business Directory plugin by CreativeMinds is the one for you. This plugin gives you the ability to create an embeddable directory for your WordPress site. The extra addition of an Add-On will support new entries and editable entries by your site users who wish to be listed.

[youtube http://www.youtube.com/watch?v=E12N_a-K5iQ]

> #### Directory Plugin Site
> * [Directory Plugin Site](https://www.cminds.com/store/purchase-cm-business-directory-plugin-for-wordpress/)
> * [Directory Plugin User Guide](hhttps://www.cminds.com/wordpress-plugins-knowledge-base-and-documentation/?hscat=370-cm-business-directory-cmbd)
> * [Plugin Pro Version Features](https://www.cminds.com/store/purchase-cm-business-directory-plugin-for-wordpress/#features)
> * You can [add your WordPress business](http://listwp.com/add-your-business/) to the ListWp.com site and check how the business directory plugin works

---

> #### Add-Ons & Extensions
>
> *  [CM Business Directory Community AddOn](https://www.cminds.com/store/cm-business-directory-community-addon-for-wordpress/)

---

> #### Demo site - ListWP.com
> * Plugin demo [Read Only mode](http://listwp.com/).
> * You can [add your WordPress business](http://listwp.com/add-your-business/) to the ListWp.com site and test how the business directory plugin works
...
* Include business info and social media links
* Generate internal ads (AdSense, etc.)
* Export/import info
* Add custom meta data
* Filter by business category
* More design options
* Customize design of business page
* Moderate additional listings
...
== Changelog ==
> [View Release Notes in CM Business Directory Site](https://www.cminds.com/store/purchase-cm-business-directory-plugin-for-wordpress/#changelog)
>
== Screenshots ==

1. CM Business Directory business index
2. CM Business Directory business page
3. CM Business Directory business grid in admin panel
4. CM Business Directory backend edit
5. CM Business Directory index page settings in the plugin settings area
