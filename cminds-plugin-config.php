...
$cminds_plugin_config = array(
	...
	'plugin-store-url'			 => 'https://www.cminds.com/store/purchase-cm-business-directory-plugin-for-wordpress/',
	...
	'plugin-compare-table'		 => '<div class="pricing-table" id="pricing-table">
                <ul>
                    ...
                    <li>Choose the way to display business address</li>
                    <li>X</li>
                    <li>X</li>
                    <li>X</li>
                    <li>X</li>
                ...
                <ul>
                    ...
                    <li class="action"><a href="https://www.cminds.com/store/purchase-cm-business-directory-plugin-for-wordpress/" target="_blank">Buy Now</a></li>
                     <li>Create any number of listings</li>
                    <li>Choose the default business image</li>
                    <li>Choose the business category</li>
                    <li>Choose the basic styling options</li>
                    ...
                    <li>Import / Export</li>
                    <li>Custom CSS</li>
                    <li>Several business directory Views</li>
   ...
   <ul>
                    ...
                    <li>Tags support</li>
                    <li>Ordering options</li>
                    <li>Users can post new business</li>
                    <li>Uswr can cliam exisiting businesses</li>
                    <li>User can manager thier businesses</li>
                  <li class="price">$55.00</li>
                    <li class="action"><a href="https://www.cminds.com/store/purchase-cm-business-directory-plugin-for-wordpress/" target="_blank">Buy Now</a></li>
                </ul>
